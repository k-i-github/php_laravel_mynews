...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="{{ action('ProfileController@index') }}" role="button" class="btn btn-primary">新規作成</a>
            </div>
            <div class="col-md-8">
                    ...
                    <table class="table table-dark">
                        ...
                        @foreach($posts as $profile)
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <a href="{{ action('ProfileController@index', ['id' => $profile->id]) }}">編集</a>
                                    </div>
                                    <div>
                                        <a href="{{ action('ProfileController@index', ['id' => $profile->id]) }}">削除</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
